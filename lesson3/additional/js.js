...
for (const elem of usersList) {
 ...
 document.write(` <h2>ID - ${elem.id } NAME -${elem.name } USERNAME - ${elem.username } </h2>`)
 document.write(` <h3>EMAIL - ${elem.email } PHONE - ${elem.phone }</h3>`)
    document.write(` <div class="address-block">`)
        document.write(` <p>City - ${elem.address.city} ADDRESS.CITY -  </p>
                         <p>Street - ${elem.address.street} ADDRESS.STREET </p>
                         <p>Suite - ${elem.address.suite} ADDRESS.SUITE</p>
                         <p>Zip code - ${elem.address.zipcode} ADDRESS.ZIPCODE</p>`)
    document.write(` </div>`)
 document.write(` </div>`)
